	...
	<div class="container">
      ...
      <br><br> -->
    	...
    	<div class="searchfilterform">
		    ...
		    <form:form class="row" method="get" action="/user/item_search" id="form">

		    	<div class="col-3">
					<form:button class="form-control filterbutton btn btn-info my-0 btn-primary mx-auto" href="item_search.html" type="submit" value="Search and Filter">
					</form:button>
			    </div>

	    	<div class="col-6">
		          <div class="smallsearchbar input-group mb-4">
		            <form:input path="name" type="text" placeholder="Search..." aria-describedby="button-addon5" class="form-control bar">
		            </form:input>
    		...
    		<div class = "col-3 tagColor">
    			...
    			<fieldset>
					...
					<form:SELECT path="category" type="text" class = "form-control tags" NAME="tag">
					    <OPTION VALUE="no" SELECTED>none
    		...
    		<div class = "itemsfound row">
    				...
    				<!-- <div class = "item col-3">
    					...
    					<a class="btn btn-primary mx-auto" href="log_availability.html" role="button">Buy Item</a>
    				</div>
    				<div class = "item col-3">
    					<img style="max-height: 100%; max-width: 100%" src="1.png" alt="IMAGE HERE">
    					<div class="nameAndPrice">NAME | $12345</div>
